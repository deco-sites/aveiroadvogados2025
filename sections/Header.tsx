  ...
  return (
    <nav class="drawer drawer-end">
      ...
      <div class="bg-slate-800 w-full">
        <div class="bg-slate-800 drawer-content container lg:px-0 px-4 flex gap-8 items-center justify-between py-4">
          <a href="/">
      ...
      <aside class="drawer-side z-50">
        ...
        <div class="flex flex-col gap-8 min-h-full w-80 bg-slate-800 text-base-content">
          <a class="p-4" href="/">
            <Image
              src={logo.src || ""}
              width={100}
